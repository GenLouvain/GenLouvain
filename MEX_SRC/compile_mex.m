...
if exist('OCTAVE_VERSION','builtin')
    ...
    mex -largeArrayDims CXXFLAGS="\$CXXFLAGS -O4 -std=c++0x" -Imatlab_matrix metanetwork_reduce.cpp matlab_matrix/full.cpp matlab_matrix/sparse.cpp group_index.cpp

    mex -largeArrayDims CXXFLAGS="\$CXXFLAGS -O4 -std=c++0x" -Imatlab_matrix group_handler.cpp matlab_matrix/full.cpp matlab_matrix/sparse.cpp group_index.cpp
end
